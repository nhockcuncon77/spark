...
description: How to propose changes, write tests, and land high-quality PRs for Spark.
icon: "handshake"
---
...
Thanks for your interest in contributing to Spark! This guide explains how to file issues, propose changes, write tests, and open pull requests (PRs) that can be reviewed and merged smoothly.

Spark’s stack includes:
