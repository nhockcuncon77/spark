    ...
    return (
        <section className="py-32 relative overflow-hidden flex items-center justify-center">
            ...
            <div className="container relative z-10 text-center">
                ...
                >
                    <button className="relative group px-10 py-5 bg-white text-bg-primary font-bold rounded-full text-xl overflow-hidden transition-all hover:shadow-[0_0_50px_rgba(124,58,237,0.4)] hover:scale-105">
