    ...
    <div className="min-h-screen bg-bg-primary text-text-primary selection:bg-brand-purple selection:text-white">
      ...
      <main className="container max-w-4xl mx-auto px-4 py-16">
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-text-secondary">
          ...
          <section>
            <h2 className="text-xl font-semibold text-white mt-8 mb-2">Summary</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-white mt-8 mb-2">Data we collect</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-white mt-8 mb-2">Your rights</h2>
            <p>
