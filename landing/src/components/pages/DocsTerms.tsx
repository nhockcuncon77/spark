export const DocsTerms = () => (
  <>
    ...
    <div className="space-y-8 text-text-secondary">
      ...
      <section>
        <h2 className="text-2xl font-semibold text-white mt-8 mb-4">1. Eligibility</h2>
      ...
      <section>
        <h2 className="text-2xl font-semibold text-white mt-8 mb-4">2. Your account</h2>
        <p>
      ...
      <section>
        <h2 className="text-2xl font-semibold text-white mt-8 mb-4">3. Verification &amp; safety</h2>
        <p>
